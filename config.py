...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6067163890:AAE8D8GuQQ5LbRS5GycxpgnhPTfgdyuthbU")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002079910653"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "1850233338"))

#Port
PORT = os.environ.get("PORT", "2589")

#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://asubang:asubang@cluster0.dnjfe.mongodb.net/?retryWrites=true&w=majority")
DB_NAME = os.environ.get("DATABASE_NAME", "indojepang")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001376531540"))
